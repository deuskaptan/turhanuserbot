...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/deuskaptan/turhanuserbot/tree/master/userbot")
            ...
            if event.query.user_id == uid and query == "@turhanuserbot":
                ...
                result = builder.article(
                    ...
                    text="{}\nYüklenen Modül Sayısı: {}".format(
                        "Merhaba! Ben @turhanuserbot kullanıyorum!\n\nhttps://github.com/deuskaptan/turhanuserbot/tree/master/userbot", len(moduller)),
                    buttons=buttons,
                    link_preview=False
                )
...
Hesabınızı bot'a çevirebilirsiniz ve bunları kullanabilirsiniz. Unutmayın, siz başkasının botunu yönetemezsiniz! Alttaki GitHub adresinden tüm kurulum detayları anlatılmıştır.""",
                    buttons=[
                        ...
                        [custom.Button.url(
                            "GitHub", "https://github.com/deuskaptan/turhanuserbot/tree/master/userbot/")]
                    ],
                    link_preview=False
                )
